 ...
 */
define("WECHAT_URL", C('WECHAT_URL'));
define('WECHAT_TOKEN', C('WECHAT_TOKEN'));
define('ENCODING_AES_KEY', C('ENCODING_AES_KEY'));

/*
 * 开发者配置
 */
define("WECHAT_APPID", C('WECHAT_APPID'));
define("WECHAT_APPSECRET", C('WECHAT_APPSECRET'));
