<?php
namespace Think\Aliwappay\wappay\service;
/* *
...
// require dirname ( __FILE__ ).DIRECTORY_SEPARATOR.'./../../config.php';//改为TP中的C方法 刘星修改
...
class AlipayTradeService {
	...
	function __construct($alipay_config){
		...
		if(empty($this->appid)||trim($this->appid)==""){
			throw new \Exception("appid should not be NULL!");//appid 不能为空
		}
		if(empty($this->private_key)||trim($this->private_key)==""){
			throw new \Exception("private_key should not be NULL!");//私钥不能为空
		}
		if(empty($this->alipay_public_key)||trim($this->alipay_public_key)==""){
			throw new \Exception("alipay_public_key should not be NULL!");//公钥不能为空
		}
		if(empty($this->charset)||trim($this->charset)==""){
			throw new \Exception("charset should not be NULL!");//编码格式不能为空
		}
		if(empty($this->gateway_url)||trim($this->gateway_url)==""){
			throw new \Exception("gateway_url should not be NULL!");//网关不能为空
		}
