...
window.___E_mod(function (E, $) {
	...
	E.config = {
		...
		// 表情图标配置
		happy:[
			'/fhbm/public/plugins/mobile_editor/img/qq/1.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/2.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/3.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/4.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/5.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/6.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/7.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/8.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/9.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/10.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/11.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/12.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/13.gif',
			'/fhbm/public/plugins/mobile_editor/img/qq/14.gif',
		] ,

		// 上传图片
		uploadImgUrl: '/fhbm/uploadImgUrl',
...
window.___E_mod(function (E, $) {
	...
	E.fn.addTxt = function () {
		...
		var $txt = $(
			'<div contentEditable="true" id="wangEContent" class="wangEditor-mobile-txt">' + 
			val + 
			'</div>'
		);
				...
				$inputFlie.on('change', function (e) {
					...
					reader.onload = function(e){
			            ...
			            xhr.onload = function () {
			            	...
			            	var jsonobj=eval('('+resultSrc+')');
			            	// 返回数据错误
			            	if (jsonobj.error == 1) {
			            		erroInfo =jsonobj.message;
